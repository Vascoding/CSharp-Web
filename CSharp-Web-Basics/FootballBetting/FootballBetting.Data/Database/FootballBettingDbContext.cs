namespace FootballBetting.Data.Database
{
    ...
    public class FootballBettingDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-924HS8U\SQLEXPRESS;Database=FootballBetting;Integrated Security=True;");
        }
